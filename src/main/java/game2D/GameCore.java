 ...
 * @author David Cairns
 * <p>
 * Core Game class that implements default game loop. Subclasses should implement the draw() method and override the
 * update method.
 */
public abstract class GameCore extends JFrame implements KeyListener {
    ...
    /**
     * Starts the game by first initialising the game via init() and then calling the gameLoop()
     *
     ...
     * <p>
     * This method will call your update() method followed by your draw() method to display the updated game state. It
     * implements double buffering for both full screen and windowed mode.
     */
    ...
    /**
     * Handles the keyReleased event to check for the 'Escape' key being pressed. If you override this method, make sure
     * you allow the user to stop the game.
     */
    ...
    /**
     * Updates the state of the game/animation based on the amount of elapsed time that has passed. You should override
     * this in your game class to do something useful.
     */
    public void update(long elapsedTime) { /* do nothing  */ }


    /**
     * Subclasses must override this method to draw output to the screen via the Graphics2D object 'g'.
     *
