...
public class Animation {
    ...
    /**
     * Works out which frame to display, incorporating the offset.
     *
    ...
    /**
     * Gets the image associated with frame 'i'. This may be useful if you have loaded a set of images from a sprite
    ...
    /**
     * Loads a complete animation from an animation sheet and adds each frame in the sheet to the animation with the
     * given frameDuration.
     *
    ...
    /**
     * Loads a set of images from a sprite sheet so that they can be added to an animation. Courtesy of Donald
     * Robertson.
     *
     * @param sheet
     * @param rows
